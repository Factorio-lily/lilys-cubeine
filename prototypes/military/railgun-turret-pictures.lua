...
local function railgun_turret_base_direction(inputs)
  return
  {
    layers =
    {
      util.sprite_load("__lilys-cubeine-asset-pack__/graphics/entity/railgun-turret/railgun-turret-base",
      {
        frame_index = inputs.frame_index,
        scale = 0.5
      }),
      util.sprite_load("__lilys-cubeine-asset-pack__/graphics/entity/railgun-turret/railgun-turret-base-mask",
      {
        flags = {"mask"},
      ...
      util.sprite_load("__lilys-cubeine-asset-pack__/graphics/entity/railgun-turret/railgun-turret-base-shadow",
      {
        frame_index = inputs.frame_index,
        draw_as_shadow = true,
        scale = 0.5
...
local function railgun_turret_extension_direction(inputs)
  return
  {
    layers =
    {
      util.sprite_load("__lilys-cubeine-asset-pack__/graphics/entity/railgun-turret/railgun-turret-rising-"..inputs.direction,
      {
      ...
      util.sprite_load("__lilys-cubeine-asset-pack__/graphics/entity/railgun-turret/railgun-turret-rising-"..inputs.direction.."-mask",
      {
        run_mode = inputs.run_mode or nil,
        flags = {"mask"},
        apply_runtime_tint = true,
      ...
      util.sprite_load("__lilys-cubeine-asset-pack__/graphics/entity/railgun-turret/railgun-turret-ammo-"..inputs.direction,
      {
        direction_count = 1,
        line_length = 5,
        frame_count = 1,
      ...
      util.sprite_load("__lilys-cubeine-asset-pack__/graphics/entity/railgun-turret/railgun-turret-shooting-"..inputs.direction.."-EMIT",
      {
        direction_count = 1,
        frame_index = 9,
      ...
      util.sprite_load("__lilys-cubeine-asset-pack__/graphics/entity/railgun-turret/railgun-turret-rising-"..inputs.direction.."-shadow",
      {
...
local function railgun_turret_aiming_direction(inputs)
  ...
  return
  {
    layers =
    {
      util.sprite_load("__lilys-cubeine-asset-pack__/graphics/entity/railgun-turret/railgun-turret-shooting-"..inputs.direction,
      {
      ...
      util.sprite_load("__lilys-cubeine-asset-pack__/graphics/entity/railgun-turret/railgun-turret-shooting-"..inputs.direction.."-mask",
      {
        middle_orientation = middle_orientation,
        orientation_range = orientation_range,
        direction_count = direction_count,
      ...
      util.sprite_load("__lilys-cubeine-asset-pack__/graphics/entity/railgun-turret/railgun-turret-shooting-"..inputs.direction.."-shadow",
      {
        middle_orientation = middle_orientation,
        orientation_range = orientation_range,
        direction_count = direction_count,
...
local function railgun_turret_resource_indicator_direction(inputs)
  ...
  return
  {
    layers =
    {
      util.sprite_load("__lilys-cubeine-asset-pack__/graphics/entity/railgun-turret/railgun-turret-shooting-"..inputs.direction.."-LED",
      {
        direction_count = direction_count,
        middle_orientation = middle_orientation,
        orientation_range = orientation_range,

...
local reactor = {
  ...
  icon                                 = "__lilys-cubeine-asset-pack__/graphics/entity/reactor/research-center-icon.png",
  ...
  connection_patches_connected         =
  {
    sheet =
    {
      filename = "__lilys-cubeine-asset-pack__/graphics/entity/reactor/reactor-connect-patches-large.png",
      width = 64,
      height = 64,
      variation_count = 21,
      scale = 0.5,
  ...
  heat_connection_patches_connected    =
  {
    sheet = apply_heat_pipe_glow
        {
          filename = "__lilys-cubeine-asset-pack__/graphics/entity/reactor/reactor-connect-patches-heated-large.png",
          width = 64,
          height = 64,
          variation_count = 21,
          scale = 0.5,
  ...
  picture =
  {
    ...
    {
      {
        filename = "__lilys-cubeine-asset-pack__/graphics/entity/reactor/research-center-hr-animation-1.png",
        width = 590,
        height = 640,
        scale = 0.5,
        shift = { 0, -0.5 },
      ...
      {
        filename = "__lilys-cubeine-asset-pack__/graphics/entity/reactor/research-center-hr-shadow.png",
        width = 1200,
        height = 700,
        scale = 0.5,
        shift = { 0, -0.5 },
  ...
  heat_buffer                =
  {
    ...
    --[[heat_picture = {
        filename = "__lilys-cubeine-asset-pack__/graphics/entity/reactor/research-center-hr-emission-1.png",
        mode = "additive-soft",
        tint = {1, 0.4, 0.1, 1},
...
data:extend({
  {
    ...
    icons = {
      {
        icon = "__lilys-cubeine-asset-pack__/graphics/entity/reactor/research-center-icon-big.png",
        icon_size = 640,
        --scale = 640/256,
      },
      {

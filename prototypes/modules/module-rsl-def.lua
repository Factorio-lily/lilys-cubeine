...
for name, proto in pairs(list1) do
    ...
    local my_rsl_registration = {
        ...
        data = {
            ...
            random = true,
            random_results = {
                {name = base_name, weight = base_chance},
                {name = degraded_name, weight = degraded_chance},
                {name = destroyed_name, weight = destroyed_chance }, 
                {name = hyper_name, weight = hyper_chance }
            }
        }
    }
